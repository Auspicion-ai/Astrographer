...
function copyNode(n: RagNode): RagNode {
  return { id: n.id, type: n.type, content: n.content, nodeKind: n.nodeKind, children: n.children !== undefined ? deepCopy(n.children) : undefined, ...(Array.isArray(n.documentPath) ? { documentPath: [...n.documentPath] } : {}), ...(Array.isArray(n.tags) ? { tags: [...n.tags] } : {}), props: n.props !== undefined ? deepCopy(n.props) : undefined, ownedNodeIds: [...n.ownedNodeIds], createdAt: n.createdAt, updatedAt: n.updatedAt }
}
