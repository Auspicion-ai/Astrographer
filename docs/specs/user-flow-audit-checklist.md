...
| UF-SHELL-4 | Astrographer branding (not the forked demo title) | defects LIVE-1 | At boot the shell title/header reads Astrographer (or an app landing), not "Provident-Electron — MCP endpoint demo" | NONE — LIVE-1 FIXED, assert only |
