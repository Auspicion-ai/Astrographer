...
describe('U-D6 §5.6.18 — the zod rows (SDK listTools)', () => {
  ...
  it('§5.7.16 GUARD — ProvidentMcpServer.ALL_TOOLS is 59 (U-D6 added no tool; U-D7 added edit.set_doc_meta; U-SHELL-9a added provident.focus; U-JR1 added provident.get_journal)', () => {
