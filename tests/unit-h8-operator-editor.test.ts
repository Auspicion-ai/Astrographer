...
describe('§5.8 — the negative pins: NO new MCP tool / census stays 41 / not group-gated / provident-authored / mechanism modules UNTOUCHED', () => {
  it('GREEN-guard (census-41) — ALL_TOOLS STAYS 41 entries and carries NO rag.manage / rag.list_stores / store-census tool (U-H8 adds 0 MCP tools, D6/A-P2-6)', () => {
    expect(ProvidentMcpServer.ALL_TOOLS).toHaveLength(41)
