...
describe('§5.8 — the negative pins: NO new MCP tool / census stays 41 / not group-gated / provident-authored / mechanism modules UNTOUCHED', () => {
  it('GREEN-guard (census) — ALL_TOOLS is 58 entries (41 + the 3 gnosis.* names + the 11 A2 document/wiki names + rag.list_documents + U-D7 edit.set_doc_meta + U-SHELL-9a provident.focus) and carries NO rag.manage / rag.list_stores / store-census tool (U-H8 adds 0 MCP tools, D6/A-P2-6)', () => {
    // Census is 58, not 41: the gnosis.* MCP/UI wiring unit added gnosis.query /
